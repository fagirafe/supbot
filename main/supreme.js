...
var Supreme = /** @class */ (function (_super) {
    ...
    Supreme.prototype.getMobileStock = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.page.url()];
                    case 1:
                        url = _a.sent();
    ...
    Supreme.prototype.searchProductByKeywords = function (productToSearch) {
        return __awaiter(this, void 0, void 0, function () {
            var stock, error_1, categories, categoryKey, _i, _a, product, stockProductName;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        error_1 = _b.sent();
                        return [2 /*return*/, Promise.reject("Could not get stock: " + error_1)];
                    case 3:
                        categories = stock["products_and_categories"];
                        for (categoryKey in categories) {
                            if (categoryKey == productToSearch.category) {
                                for (_i = 0, _a = categories[categoryKey]; _i < _a.length; _i++) {
                                    product = _a[_i];
                        ...
                        return [2 /*return*/, Promise.reject("Could not find product by keywords!")];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        url = _a.sent();
                        if (!url.includes(this.baseUrl)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.page.evaluate(function (id) {
                                return new Promise(function (resolve, reject) {
                                    var xmlhttp = new XMLHttpRequest();
    ...
    Supreme.prototype.getProductState = function (id, product) {
        return __awaiter(this, void 0, void 0, function () {
            var productDetails, productStyles, _i, productStyles_1, productStyle, productSizes, _a, productSizes_1, productSize, stockProductSize, _b, productSizes_2, productSize, stockProductSize;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.getProduct(id)];
                    case 1:
                        productDetails = _c.sent();
                        productStyles = productDetails["styles"];
                        for (_i = 0, productStyles_1 = productStyles; _i < productStyles_1.length; _i++) {
                            ...
                            if (productStyle["name"].includes(product.style)) {
                                ...
                                for (_a = 0, productSizes_1 = productSizes; _a < productSizes_1.length; _a++) {
                                ...
                                if (product.sizeAlternative != "None") {
                                    for (_b = 0, productSizes_2 = productSizes; _b < productSizes_2.length; _b++) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.page.goto(productUrl, { waitUntil: "networkidle2" })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.page.waitForSelector("#size-options")];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.page.evaluate(function (sizeId) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5: return [4 /*yield*/, this.page.waitForSelector("#mobile_checkout_form")];
                    case 6:
                        _a.sent();
                        return [4 /*yield*/, this.page.evaluate(function (profile, recaptchaResponseToken) {
                                ...
                                document.getElementById("order_tel").value =
                                    profile["tel"];
                                (document.getElementById("order_billing_address")).value = profile["address"];
                                ...
                                (document.getElementById("credit_card_type")).value = profile["type"].toLowerCase();
                                ...
                                document.getElementById("credit_card_cvv").value =
                                    profile["cvv"];
                                (document.querySelector("input[name='order[terms]']")).value = "1";
                                document.getElementById("order_terms").value = "1";
                                (document.getElementById("g-recaptcha-response")).value = recaptchaResponseToken;
                            }, JSON.parse(JSON.stringify(profile)), recaptchaResponseToken)];
                    case 7:
                        _a.sent();
                        return [4 /*yield*/, this.page.evaluate(function () {
                    ...
                    case 8:
                        ...
                        if (total > settings["priceLimit"]) {
                            throw new Error("Order total of " +
                                total +
